...
const cesiumDataSource = './src/assets/SampleData'
...
if (process.env.NODE_ENV === 'production') {
  plugins = [
    ...
    new CopyWebpackPlugin([
      { from: path.join(cesiumDataSource, ''), to: 'static/SampleData' }
    ])
  ]
} else {
  plugins = [
...
module.exports = {
  ...
  chainWebpack(config) {
    ...
    config.module
      ...
      .end()
    // set cesium datasource glb/gltf file
    config.module
      .rule('glb')
      .test(/\.glb|.gltf|.bin$/)
      .include.add(resolve('src/assets/SampleData'))
      .end()
      .use('url-loader')
      .loader('url-loader')
      .options({
